...
export type LaunchLatestQueryVariables = Exact<{ [key: string]: never }>

export type LaunchLatestQuery = {
  __typename?: 'Query'
  launchLatest?: {
    __typename?: 'Launch'
    mission_name?: string | null
    rocket?: { __typename?: 'LaunchRocket'; rocket_name?: string | null } | null
    ships?: Array<{ __typename?: 'Ship'; image?: string | null } | null> | null
  } | null
}

export const LaunchLatestDocument = gql`
  query LaunchLatest {
    launchLatest {
      mission_name
      rocket {
...
/**
 * __useLaunchLatestQuery__
 *
 * To run a query within a React component, call `useLaunchLatestQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchLatestQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaunchLatestQuery({
 *   variables: {
 *   },
 * });
 */
export function useLaunchLatestQuery(
  baseOptions?: Apollo.QueryHookOptions<
    LaunchLatestQuery,
    LaunchLatestQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<LaunchLatestQuery, LaunchLatestQueryVariables>(
    LaunchLatestDocument,
    options
  )
}
export function useLaunchLatestLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<LaunchLatestQuery, LaunchLatestQueryVariables>(
    LaunchLatestDocument,
    options
  )
}
export type LaunchLatestQueryHookResult = ReturnType<
  typeof useLaunchLatestQuery
>
export type LaunchLatestLazyQueryHookResult = ReturnType<
  typeof useLaunchLatestLazyQuery
>
export type LaunchLatestQueryResult = Apollo.QueryResult<
  LaunchLatestQuery,
  LaunchLatestQueryVariables
>

export const LaunchLatestDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'LaunchLatest' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<LaunchLatestQuery, LaunchLatestQueryVariables>
